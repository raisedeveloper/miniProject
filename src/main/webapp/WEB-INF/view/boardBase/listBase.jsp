...
<script>
	function search() {
		...
		location.href = '/jw/bbs/board/list?p=${currentBoardPage}&f=' + field
				+ '&q=' + query;
	}
</script>
</head>
				...
				<table class="table table-sm table-borderless">
					<tr>
						<td style="width: 52%; text-align: left">
							<h3>
								<strong class="me-5">게시글 목록</strong> <span
									style="font-size: 16px"><a href="/jw/bbs/board/insert"><i
				...
				<ul class="pagination justify-content-center mt-4">
					...
					<c:forEach var="page" items="${pageList}">
						<li class="page-item ${currentBoardPage eq page ? 'active' : ''}">
							<a class="page-link"
							href="/jw/bbs/board/list?p=${page}&f=${field}&q=${query}">${page}</a>
						</li>
					</c:forEach>
					<li class="page-item"><a class="page-link" href="#"><i
